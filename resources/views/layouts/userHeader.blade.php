                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item noti-icon waves-effect waves-light"
                            ...
                            <span class="badge badge-danger badge-pill">{{ count($userUnreadNotifications) }}</span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                @foreach ($userUnreadNotifications as $notification)
                                    <a href="{{ url('updateUserNotifications/') . '/' . $notification['id'] . '/' . $notification['userId'] }}"
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="font-size-12 mb-1">{{ $notification['shortText'] }}</p>
                                                <p class="font-size-12 mb-0 text-muted"><i
                                                        class="mdi mdi-clock-outline"></i>{{ date('d M, Y', strtotime($notification['created_at'])) }}
                                                </p>
                                            </div>
                                        </div>
                                    </a>
